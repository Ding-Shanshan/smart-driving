            ...
            function frame() {
                {
                    if(car.type=='NormalCar')
                    {
                        if (tx === 370) {
                            // 判断路口情况 jxd
                            sign = intersectionATOC(tx, lightlist,car.type);
                        }
                    }else{
                        if (tx === 394) {
                            // 判断路口情况 jxd
                    ...
                    switch (sign) {
                        ...
                        case 1:
                            ...
                            sy = ty;
                            if (tx >= 420) {
                                sign = intersectionATOC(tx, lightlist1,car.type);
                                console.log(tx, sign)
                            }
                            break; //正常行驶
                        case 2:
            ...
            function frame() {
                if (tx === _self.W - 100) {
                     ...
                     if(car.type=='NormalCar')
                    {
                        if (tx === 370) {
                            // 判断路口情况 jxd
                            sign = intersectionATOB(tx, lightlist,car.type);
                        }
                    }else{
                        if (tx === 394) {
                            // 判断路口情况 jxd
            ...
            function frame() {
                {
                    if(car.type=='NormalCar')
                    {
                        if (tx === 610) {
                            // 判断路口情况 jxd
                            sign = intersectionBTOD(tx, lightlist,car.type);
                        }
                    }else{
                        if (tx === 586) {
                            // 判断路口情况 jxd
            ...
            function frame() {
                if (tx <= 100) {
                    ...
                    if(car.type=='NormalCar')
                    {
                        if (tx === 610) {
                            // 判断路口情况 jxd
                            sign = intersectionBTOA(tx, lightlist,car.type);
                        }
                    }else{
                        if (tx === 586) {
                            // 判断路口情况 jxd
