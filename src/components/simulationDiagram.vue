...
export default {
  ...
  methods: {
    ...
    textConnection(data) {
      ...
      let smartCarTargetNum =
        parseInt(data.totalNum) * parseFloat(data.proportion)
      ...
      function createIdxAndobjs() {
        ...
        if (normalCarCurNum + smartCarCurNum === parseInt(data.totalNum)) {
          ...
          //两者都少于预期生成的数量时，随机生成
          if (
            normalCarCurNum < normalCarTargetNum &&
            smartCarCurNum < smartCarTargetNum
          ) {
          ...
          // car.showInfo();
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "D" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "A"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawDToA(
              rootSelf,
              rootSelf.W / 2 + (rootSelf.RoadW - rootSelf.carW) / 2,
              rootSelf.H - 100
            )
          }
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "D" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "C"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawDToC(
              rootSelf,
              rootSelf.W / 2 + (rootSelf.RoadW - rootSelf.carW) / 2,
              rootSelf.H - 100
            )
          ...
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "D" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "B"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawDToB(
              rootSelf,
              rootSelf.W / 2 + (rootSelf.RoadW - rootSelf.carW) / 2,
              rootSelf.H - 100
            )
          ...
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "D" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "D"
          ) {
          }

          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "A" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "D"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawAToD(
              rootSelf,
              100,
              rootSelf.H / 2 + 20
            )
          ...
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawAToC(
              rootSelf,
              100,
              rootSelf.H / 2 + 20
            )
          ...
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawAToB(
              rootSelf,
              100,
              rootSelf.H / 2 + 20
            )
          ...
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "C" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "D"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawCToD(
              rootSelf,
              rootSelf.W / 2 -
                rootSelf.RoadW +
                (rootSelf.RoadW - rootSelf.carW) / 2,
              100
            )
          }
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawCToA(
              rootSelf,
              rootSelf.W / 2 -
                rootSelf.RoadW +
                (rootSelf.RoadW - rootSelf.carW) / 2,
          ...
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawCToB(
              rootSelf,
              rootSelf.W / 2 -
                rootSelf.RoadW +
                (rootSelf.RoadW - rootSelf.carW) / 2,
          ...
          if (
            rootSelf.AllCar[rootSelf.carIdx].sourcePlace === "B" &&
            rootSelf.AllCar[rootSelf.carIdx].targetPlace === "D"
          ) {
            rootSelf.AllCar[rootSelf.carIdx].drawBToD(
              rootSelf,
              rootSelf.W - 100,
              rootSelf.H / 2 -
                rootSelf.RoadW +
          ...
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawBToA(
              rootSelf,
              rootSelf.W - 100,
              rootSelf.H / 2 -
                rootSelf.RoadW +
          ...
          if (
            ...
            rootSelf.AllCar[rootSelf.carIdx].drawBToC(
              rootSelf,
              rootSelf.W - 100,
              rootSelf.H / 2 -
                rootSelf.RoadW +
